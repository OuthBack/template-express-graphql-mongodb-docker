...
console.log(chalk.yellow("Query"), " graphs are", chalk.yellow("loading ..."));
let modulePath = "src/modules/**/graphs/queries/*.query.js";
const modules = {};
...
console.log(chalk.yellow("Query"), " graphs are", chalk.green("loaded"));
